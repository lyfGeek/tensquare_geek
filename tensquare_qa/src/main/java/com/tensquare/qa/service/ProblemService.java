...
import com.tensquare.qa.dao.IProblemDao;
...
public class ProblemService {
    ...
    public Page<Problem> newlist(String labelid, int page, int size) {
        Page<Problem> list = problemDao.findNewListByLabelid(labelid, PageRequest.of(page - 1, size));
        return list;
    }
    ...
    public Page<Problem> hotlist(String labelid, int page, int size) {
        Page<Problem> list = problemDao.findHotListByLabelid(labelid, PageRequest.of(page - 1, size));
        return list;
    }
    ...
    public Page<Problem> waitlist(String labelid, int page, int size) {
        Page<Problem> list = problemDao.findWaitListByLabelid(labelid, PageRequest.of(page - 1, size));
        return list;
    }
